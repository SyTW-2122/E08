  ...
  return (
    <div className="formSend">
      <form action="#" onSubmit={onHandleSubmit}>
        ...
        <div className="form-group">
          <input data-testid="input-confirm"
            type="password"
            id="confirmPassword"
          ...
          {alertConfirmPassword && (
            <p data-testid='alertconfirm'>The password does not match</p>
          )}
        </div>
        <button data-testid="button-send" className="button-send">Register</button>
      </form>
